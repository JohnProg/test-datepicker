...
describe('Android 23 - DatePicker', function() {
  let driver
  this.timeout(300000)
  ...
  before(() => {
    ...
    return driver.init(config.android23)
  })
  ...
  it('should set date 10', () => {
    return driver
      ...
      .click()
      .elementByXPath("//android.view.View[@text='10']")
  ...
  it('should select year 2015', () => {
    return driver
      .elementById('android:id/date_picker_header_year')
      .should.eventually.exist.click()
